...
PluginServicesHtml::header_nocache();
...
if (isset($_POST["validatortype"])) {
   switch ($_POST["validatortype"]) {
      case 'user' :
         ...
         PluginServicesUser::dropdown(['name' => !empty($_POST['name']) ? $_POST['name'].'[]'
                                                               :'users_id_validate[]',
                              'entity' => $_POST['entity'],
                              'value'  => $value,
                              'right'  => $_POST['right']]);
      ...
      case 'group' :
         ...
         $rand = PluginServicesGroup::dropdown(['name'      => $name,
                                       'value'     => $value,
                                       'entity'    => $_POST["entity"]]);
         ...
         PluginServicesAjax::updateItemOnSelectEvent("dropdown_$name$rand", "show_list_users",
         ...
         if ($value) {
            ...
            PluginServicesAjax::updateItem('show_list_users', $CFG_GLPI["root_doc"]."/ajax/dropdownValidator.php",
            $param);
         }
         echo "<div class='mt-1 mb-1' id='show_list_users'>&nbsp;</div>\n";
         break;
      ...
      case 'list_users' :
         ...
         $users = PluginServicesToolbox::stripslashes_deep($users);
         $rand  = PluginServicesDropdown::showFromArray(!empty($_POST['name']) ? $_POST['name']:'users_id_validate',
                                          $users, $param);
         ...
         //       'right'             => $_POST['right'],
         //    ];
         //    PluginServicesAjax::updateItemOnEvent('all_users', 'show_list_users',
         //                            $CFG_GLPI["root_doc"]."/ajax/dropdownValidator.php",
         //                            $param_button, ['click']);

         //    echo "&nbsp;<a id='no_users' class='vsubmit'>".__('None')."</a>";
         //    $param_button['all_users'] = 0;
         //    PluginServicesAjax::updateItemOnEvent('no_users', 'show_list_users',
         //                            $CFG_GLPI["root_doc"]."/ajax/dropdownValidator.php",
         //                            $param_button, ['click']);
         // }
         break;
