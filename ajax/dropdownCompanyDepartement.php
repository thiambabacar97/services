...
if (!empty($_POST["value"])) {
   ...
   $data_departement  = PluginServicesCompany::getAllDepartementsOssociatedWithSelectedCompany($_POST["value"]);
   ...
   $rand  = PluginServicesDropdown::showFromArray('departements_id', $departements, $param);
}else{
