...
/// Class Ticket links
class PluginServicesTicket_Ticket extends Ticket_Ticket {
  ...
  **/
   ...
   **/
   static function displayLinkedTicketsTo($ID) {
      ...
      $ticket    = new PluginAssistancesTicket();
      $tick      = new PluginAssistancesTicket();
   ...
   **/
   ...
   function postForm($post) {
      $ticket_ticket = new self();
      Session ::checkCentralAccess();
      if (isset($post['purge'])) {
         $ticket_ticket->check($post['id'], PURGE);

         $ticket_ticket->delete($post, 1);

         // Event::log($post['tickets_id'], "ticket", 4, "tracking",
