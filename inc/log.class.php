 ...
 * Log Class
**/
class PluginServicesLog extends Log {
   ...
   static function showForItem(CommonDBTM $item, $withtemplate = 0) {
      ...
      echo"<div class='row'>";
         echo"<div class='col-10'>";
            // on peut  mettre quelque chose en qu'a de besion sinon on garde l'espace pour afficher le à printAjaxPager gauche
         echo"</div>";
         // Display the pager
      ...
      if (isset($_GET['filters'])) {
         ...
         echo "<th><input class='form-control' type='date' name='filters[date]' value='$dateValue' /></th>";
         echo "<th>";
         PluginServicesDropdown::showFromArray(
            "filters[users_names]",
      ...
      echo"<div class='row'>";
         ...
         // Display the pager
         $additional_params = isset($_GET['filters']) ? http_build_query(['filters' => $_GET['filters']]) : '';
         // PluginServicesHtml::printAjaxPager(self::getTypeName(1), $start, $filtered_number, '', true, $additional_params);
      echo"</div>";
   }
