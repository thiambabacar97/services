...
abstract class PluginServicesLevelAgreement extends LevelAgreement {
   // From CommonDBTM
   var $dohistory          = true;
   ...
   **/
   function showForm($ID, $options = []) {
      ...
      echo"<form class='m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed'>
            <div class='m-portlet__body'>";
               ...
               echo"<div class='form-group m-form__group row'>
                  ...
                  <label class='col-lg-2 col-form-label'>"._n('Type', 'Types', 1)."</label>
                  <div class='col-lg-3'>";
               ...
               echo"<div class='form-group m-form__group row'>
                  <label class='col-lg-2 col-form-label'>".__('Maximum time')."</label>
                  <div class='col-lg-3'>
                  ...
                  echo"<label class='col-lg-2 col-form-label'></label>";
               ...
               echo"<div class='form-group m-form__group row'>
                  <label id='title_endworkingday' class='col-lg-2 col-form-label'>".__('End of working day')."</label>
                  <div class='col-lg-3' id='dropdown_endworkingday'>";
               ...
               <div class='form-group m-form__group row'>
                  <label class='col-lg-2 col-form-label'>".__('Comments')."</label>
                  <div class='col-lg-8'>
                  <textarea class='form-control m-input' cols='45' rows='8' name='comment' >".$this->fields["comment"]."</textarea>
                  </div>
               </div>
   ...
   static function showForSLM(SLM $slm) {
      ...
      if (count($laList)) {
         ...
         $header_end    = '';
         if ($canedit) {
            $header_top .= "<th width='10'>".PluginServicesHtml::getCheckAllAsCheckbox('mass'.__CLASS__.$rand);
            $header_top .= "</th>";
            $header_bottom .= "<th width='10'>".PluginServicesHtml::getCheckAllAsCheckbox('mass'.__CLASS__.$rand);
            $header_bottom .= "</th>";
         }
         ...
         foreach ($laList as $val) {
            ...
            if ($canedit) {
               PluginServicesHtml::showMassiveActionCheckBox($la->getType(), $val['id']);
            }
            echo "</td>";
            $la->getFromDB($val['id']);
   ...
   function showRulesList() {
      ...
      if (!$nb) {
         ...
         if ($canedit) {
            PluginServicesHtml::openMassiveActionsForm('massRuleTicket'.$rand);
            $massiveactionparams
         ...
         if ($canedit) {
            ...
            $header_top    .= PluginServicesHtml::getCheckAllAsCheckbox('massRuleTicket'.$rand);
            $header_bottom .= PluginServicesHtml::getCheckAllAsCheckbox('massRuleTicket'.$rand);
            $header_end    .= "</th>";
         }
         ...
         foreach ($rules_id_list as $data) {
            ...
            if ($canedit) {
               echo "<td width='10'>";
               PluginServicesHtml::showMassiveActionCheckBox("RuleTicket", $rule->fields["id"]);
               echo "</td>";
