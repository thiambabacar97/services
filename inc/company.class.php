...
class PluginServicesCompany extends CommonDBTM{

    static $rightname = "plugin_services_company";
    ...
    static function getType() {
        return "PluginServicesCompany";
    }

    static function getTable($classname = null){
        return "glpi_plugin_services_companies";
    }

    static function getTypeName($nb = 0) {
        return _n('Société', 'Sociétés', $nb);
    }
    ...
    **/
    ...
    static function dropdownCompany($options = []) {
        $p['name']  = 'companies_id';
        $p['value'] = '';
        $p['rand']  = mt_rand();
        ...
        PluginServicesDropdown::show("PluginServicesCompany", $p);
    }
    ...
    * @return array
   **/
    static function getAllDepartementsOssociatedWithSelectedCompany($companies_id) {
        global $DB;
    ...
    public function showForm($ID, $options = []) {
        ...
        $jsScript = '
            $(document).ready(function() {
                ...
                var form = $("#pluginservicescompanyform");
                var request;
                form.validate({
                    rules: {
                        name : {
