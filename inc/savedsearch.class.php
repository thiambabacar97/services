 ...
 * @since 9.2
**/
class PluginServicesSavedSearch extends SavedSearch {
   ...
   **/
   static function showSaveButton($type, $itemtype = 0) {
      ...
      echo "<a href='#' onClick=\"savesearch.dialog('open'); return false;\"
             class='btn btn-secondary bookmark_record save' title='".__s('Save current search')."'>";
             echo __s('Save');
      echo "</a>";
