  ...
  **/
   ...
   **/
   function showForm_old($ID, $options = []) {
      ...
      echo PluginServicesHtml::hidden('_no_message_link', ['value' => 1]);
      ...
      if ($canedit) {
         ...
         echo PluginServicesDropdown::getDropdownName('glpi_solutiontypes',
      ...
      if ($canedit && Session::haveRight('knowbase', UPDATE) && !isset($options['nokb'])) {
         ...
         PluginServicesDropdown::showYesNo('_sol_to_kb', false);
      ...
      if ($canedit) {
         $rand = mt_rand();
         PluginServicesHtml::initEditorSystem("content$rand");
         ...
         PluginServicesHtml::file(['editor_id' => "content$rand",
   ...
   function postForm($post){
      ...
      $solution = new self();
      if ($_POST['itemtype'] == 'PluginAssistancesTicket' ) {
   ...
   static function getSpecificValueToSelect($field, $name = '', $values = '', array $options = []) {
      ...
      switch ($field) {
         case 'status':
            ...
            return PluginServicesDropdown::showFromArray($name, self::getStatuses(), $options);
            break;
      }
   ...
   static function showSolution($item){
      ...
      echo"<div class='row d-flex justify-content-center  form-group m-form__group'>";
         ...
         echo"<div class='col-lg-12'>";
            $followup_obj = new PluginServicesITILFollowup();
         ...
         foreach ($timeline as $item) {
            ...
            echo"<div class='col-lg-9'>";
               echo'<div class="m-widget3  mb-3"  style ="border-left:2px solid '.$couleur.'; ">';
